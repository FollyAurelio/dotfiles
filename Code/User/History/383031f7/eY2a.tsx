...
export function TodoTable() {
  ...
  let location = useLocation()?.state?.filter as String
  const [statusFilters, setStatusFilters] = React.useState<{ [column: string]: string[] }>({"project" : [location]})
  ...
  table.getColumn("project")?.setFilterValue(String(statusFilters["project"]))
