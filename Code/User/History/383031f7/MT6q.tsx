...
export function TodoTable() {
  ...
  let location = useLocation().state.filter ? useLocation().state.filter : ""
  const [statusFilters, setStatusFilters] = React.useState<{ [column: string]: string[] }>({"project" : []})
  ...
  table.getColumn("project")?.setFilterValue(statusFilters["project"])
